...
import { increment, decrement, reset, incrementByAmount, setStep, } from '../features/countersSlice';

function AdvancedCounter() {
  const { value, step } = useSelector((state) => state.counters);
  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
      ...
      <p className="text-xl mb-4 dark:text-white">Count: {value}</p>
